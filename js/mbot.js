...
ext.runShutter = function(port,status){
	...
	//runPackage(20,port,0/1/2/3);
};

ext.runOutput = function(port,slot,status){
	if(typeof port=="string"){
		port = ports[port];
	}
	if(typeof slot=="string"){
	...
	if(typeof status == "string"){
		status = binario[status];
	}
	runPackage(20,port,status+slot);
};
...
function sendPackage(argList, type){
	// bytes es lo que se envia mediante el firmata 
	//type: 1 es lectura, 2 es escritura, 0 es reset 
	//[255,85,tamañoEnvio,0,0/1/2,arg1,arg2,arg3]
